...
module.exports = {
  ...
  verify: {
    desc: chalk.gray(
      ...
      'the plugins blacklist.  If a non-option argument follows, it will be ' +
      'used over the project\'s package.json.'),
  },
  tasks: {
    alias: 'T',
    type: 'boolean',
  ...
  'tasks-json': {
    desc: chalk.gray(
      ...
      'in JSON format to stdout, for the loaded gulpfile.  ' +
      'If a filename follows then the output goes to that file.'),
  },
  color: {
    type: 'boolean',
    desc: chalk.gray(
